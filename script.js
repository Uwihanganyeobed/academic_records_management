...
if (loginForm) {
    loginForm.addEventListener('submit', (e) => {
        ...
        // Redirect to dean dashboard instead of hardcoding the path
        const role = 'dean'; // In a real app, this would be determined by authentication
        
        if (role === 'dean') {
            window.location.href = './dashboards/dean-dashboard.html';
        } else if (role === 'hod') {
            window.location.href = './dashboards/hod-dashboard.html';
        } else if (role === 'lecturer') {
            window.location.href = './dashboards/lecturer-dashboard.html';
